...
export interface RolesPaginationBarProps {
  pageInfo: string
...
/** "Showing X-Y of Z" + rows-per-page + prev/next, for the role catalogue. */
export function RolesPaginationBar({ pageInfo, pageSizeOptions, pageSize, onPageSizeChange, pageLabel, prevDisabled, nextDisabled, onPrev, onNext }: RolesPaginationBarProps) {
  return (
